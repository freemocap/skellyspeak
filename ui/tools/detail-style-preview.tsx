...
function Explorer() {
  ...
  return <main className="detail-lab">
    ...
    <section id="rewards"><h2>02 · Reward meaning and presentation</h2><p><strong>Baseline:</strong> production reward badges, domain colors and sound patterns. <strong>Proposal:</strong> the replay entrance below. Full card travel, reward sequencing and haptics require native-app review.</p>
      ...
      <article><h3>Compact dock variant</h3><div className="lab-compact-badge">{badge}<p>The same evidence in a smaller inspection area.</p><small>XP is practice credit, not a proficiency score.</small></div><h3>Pending and no-new-credit states</h3><p>Pending: evidence is still being evaluated.</p><p>No new credit: keep the evidence available without a new-credit celebration.</p><small>These state labels are discussion proposals, not new app behavior.</small></article></div>
