...
import { LOCALES, requireUiLocale, validateLocales, validateLanguageLocales, t, formatNumber, formatDate } from './'

const configs = import.meta.glob('../../../../content/config/languages/languages/*.yaml', { eager: true, query: '?raw', import: 'default' })
