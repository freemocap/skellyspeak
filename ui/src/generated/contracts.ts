...
export type AccessSettings = { credentialPreviews?: { [key in string]: string }, customUrlIsUnsavedDefault: boolean, revision: number, groqKeyConfigured: boolean, elevenlabsKeyConfigured: boolean, customKeyConfigured: boolean, custom: CustomEndpoint, };
...
export type ConnectionConfig = { assessmentAdapter: AssessmentAdapter, route: ConnectionRoute, signedIn: boolean, ownKeyConfigured: boolean, email: string, revision: number, configured: boolean, standardModel: string, fastModel: string, audio: AudioSettings, paused: boolean, };
