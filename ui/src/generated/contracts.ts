...
export type Preferences = { theme: Theme, appearance: AppearancePreferences, explanationLanguage: string, explanationVarietyId: string, interfaceLocale: string, targetVarieties: { [key in string]: string }, myLanguages: Array<string>, textSize: number, textSpacing: number, highContrast: boolean, onboarding: OnboardingStatus, onboardingRequired: boolean, onboardingLanguage: string | null, onboardingHelp: boolean, };
