...
export type ProviderCredentialCheck = { provider: string, state: string, status: number | null, durationMs: number, };
...
export type ConnectionConfig = { route: ConnectionRoute, signedIn: boolean, ownKeyConfigured: boolean, email: string, revision: number, configured: boolean, standardModel: string, fastModel: string, transcriptionModel: string, paused: boolean, };
...
export type Language = { languageTag: string | null, fontScale: number, direction: string, romanization: string | null, id: string, name: string, nativeName: string, varieties: Array<Variety>, defaultVariety: string, };
export type LanguageInspection = { fingerprint: string, language: Language, varietyId: string, review: string, family: string, values: Array<ContentValue>, rules: Array<ContentRule>, schemes: Array<SchemeInspection>, sources: Array<ContentSource>, goals: Array<GoalInspection>, starters: Array<StarterInspection>, partner: PersonaDetails, schemaJson: string, resolvedJson: string, learningJson: string, conversationJson: string, };
export type GoalInspection = { id: string, label: string, criterion: string, band: string, source: string, };
export type StarterInspection = { id: string, label: string, preview: string, varieties: Array<string>, };
...
export const SKILL_CATALOG_VERSION = 2116365709 as const
