...
export type LanguageInspection = { fingerprint: string, language: Language, varietyId: string, review: string, family: string, values: Array<ContentValue>, rules: Array<ContentRule>, schemes: Array<SchemeInspection>, sources: Array<ContentSource>, goals: Array<GoalInspection>, topics: Array<TopicInspection>, partner: PersonaDetails, schemaJson: string, resolvedJson: string, learningJson: string, conversationJson: string, };
export type GoalInspection = { id: string, label: string, criterion: string, band: string, source: string, };
export type TopicInspection = { id: string, labels: { [key in string]: string }, subject: string, };
