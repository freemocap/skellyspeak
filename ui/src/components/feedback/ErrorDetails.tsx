...
type ErrorDetailsProps = { label: string; errorKey: string; children: ReactNode; explanation?: string }

export function ErrorDetails(props: ErrorDetailsProps) {
  return <DismissibleError key={props.errorKey} {...props} />
}

function DismissibleError({ label, children, errorKey, explanation }: ErrorDetailsProps) {
