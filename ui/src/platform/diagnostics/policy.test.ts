...
const cases = JSON.parse(readFileSync(new URL('../../../../redaction-policy/cases.json', import.meta.url), 'utf8')) as { name: string; text: string; private: string[]; kept: string[]; removed: string[]; tag?: string }[]
