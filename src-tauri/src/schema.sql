...
INSERT INTO ai_config VALUES(1,1,NULL,'google/gemini-2.5-flash','google/gemini-2.5-flash-lite',0,'hosted',NULL,'',NULL,NULL,'{"baseUrl":"","standardModel":"google/gemini-2.5-flash","fastModel":"google/gemini-2.5-flash","bearerAuth":true,"transcriptionModel":"whisper-large-v3"}');
