...
pub fn reply_blocks(
    ...
    vec![
        ...
        Block::new("conversation_style", "prompts/partner.rs", format!("HOW YOU TALK\n{}\n{}\nEvery reply must include one clear, easy invitation to respond: a short question, a choice, or a concrete request. Answer first; ask at most one natural, related question or offer a concrete choice. Do not turn incidental nouns into preference questions (favorite screws, liking waiting). No shared specialist interests are assumed. Simplify wording, not conversational sense. At PRE-A1, make a one-word or yes/no answer possible. Omit detail to stay within ALL practice difficulty limits. No generic praise or repeated introductions. Recast errors naturally. Return only the reply.", always_respond_rule(target_language_name), no_emoji_rule())),
