...
INSERT INTO ai_config_next SELECT *,NULL,NULL,'{"baseUrl":"","standardModel":"google/gemini-2.5-flash","fastModel":"google/gemini-2.5-flash","bearerAuth":true,"transcriptionModel":"whisper-large-v3"}' FROM ai_config;
