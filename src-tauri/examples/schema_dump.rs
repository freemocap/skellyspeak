...
fn main() {
    ...
    let raw = match which.as_str() {
        ...
        "coach" => serde_json::to_value(schema_for!(skellyspeak_lib::commands::coach::CoachFeedback)),
        _ => serde_json::to_value(schema_for!(skellyspeak_lib::commands::guided::TokensOut)),
    }
    .unwrap();
