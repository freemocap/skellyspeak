...
///
/// Usage:
///   node tools/refactor-move.ts moves.json            # report only
///   node tools/refactor-move.ts moves.json --write    # apply
///
...
/// repository root:
///   { "ui/src/lib/speech.ts": "ui/src/domain/audio/speech.ts" }
///
...
if (!mapPath) throw new Error('Usage: node tools/refactor-move.ts <moves.json> [--write]')
