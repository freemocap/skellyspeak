...
//
//   node tools/release.ts current        release the committed version
...
//
// It bumps `native/Cargo.toml` (the single source of truth for the version),
...
console.log('The separate iOS distribute workflow attaches the IPA; TestFlight upload is disabled:')
