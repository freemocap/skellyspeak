...
const colors: Record<string, { ink: string; bright: string; muted: string }> = {
  ...
  statements: { ink: 'var(--di-statements)', bright: 'var(--d-statements)', muted: 'var(--dm-statements)' },
  descriptions: { ink: 'var(--di-descriptions)', bright: 'var(--d-descriptions)', muted: 'var(--dm-descriptions)' },
  questions: { ink: 'var(--di-questions)', bright: 'var(--d-questions)', muted: 'var(--dm-questions)' },
  opinions: { ink: 'var(--di-opinions)', bright: 'var(--d-opinions)', muted: 'var(--dm-opinions)' },
  situating: { ink: 'var(--di-situating)', bright: 'var(--d-situating)', muted: 'var(--dm-situating)' },
}
