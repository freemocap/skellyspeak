...
export type ChatMessage = { id: string, sequence: number, role: string, text: string, createdAt: string, };
...
export type TurnView = { route: ConnectionRoute, id: string, state: string, paused: boolean, operations: Array<OperationView>, attempts: Array<AttemptView>, };
export type ConversationSnapshot = { coachMessages: Array<ChatMessage>, conversationId: string, sessionId: string, revision: number, messages: Array<ChatMessage>, turns: Array<TurnView>, connection: ConnectionConfig, hasOlder: boolean, };
...
export type Action = { "kind": "askCoach", conversationId: string, text: string, expectedRevision: number, } | { "kind": "startChat", languageId: string, } | { "kind": "sendMessage", conversationId: string, text: string, expectedRevision: number, } | { "kind": "controlTurn", turnId: string, control: TurnControl, } | { "kind": "setPaused", paused: boolean, } | { "kind": "createPartner", languageId: string, } | { "kind": "updatePartner", partnerId: string, expectedRevision: number, details: PartnerDetails, } | { "kind": "setRelationshipArchived", relationshipId: string, expectedRevision: number, archived: boolean, } | { "kind": "deletePartner", partnerId: string, expectedRevision: number, } | { "kind": "createConversation", relationshipId: string, title: string, } | { "kind": "openConversation", conversationId: string, } | { "kind": "updateConversation", conversationId: string, expectedRevision: number, title: string, archived: boolean, } | { "kind": "updateSettings", conversationId: string, expectedRevision: number, settings: PracticeSettings, } | { "kind": "deleteConversation", conversationId: string, expectedRevision: number, } | { "kind": "updateLearner", expectedRevision: number, name: string, preferences: Preferences, };
...
export type ErrorCode = "validation" | "conflict" | "not_found" | "session_expired" | "storage" | "provider" | "unknown_outcome" | "credential" | "internal";
