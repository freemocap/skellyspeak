...
export type GlossSegment = { start: number, end: number, kind: GlossSegmentKind, gloss: string | null, };
...
export type ChatMessage = { wordGloss: WordGlossView | null, glossState: string | null, glossError: string | null, glossOperationId: string | null, translationState: string | null, translation: string | null, id: string, sequence: number, role: string, text: string, createdAt: string, };
