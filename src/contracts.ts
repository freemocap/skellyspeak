...
export type ChatMessage = { feedback?: Feedback, feedbackState?: string, feedbackError?: string, suggestedReplies?: Array<string>, wordGloss: WordGlossView | null, glossState: string | null, glossError: string | null, glossOperationId: string | null, translationState: string | null, translation: string | null, id: string, sequence: number, role: string, text: string, createdAt: string, };
