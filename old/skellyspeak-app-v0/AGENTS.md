...
Practice difficulty belongs to the persistent conversation, not the language
profile. Language profiles aggregate progress and proficiency evidence. Continue
authorized implementation autonomously; offer concise, concrete user checks at
useful visual or native-app milestones.
...
- `src-tauri/src/learner.rs`: local learner identity and language profile persistence.
- `src-tauri/src/conversation_practice.rs`: persistent conversation practice settings.
