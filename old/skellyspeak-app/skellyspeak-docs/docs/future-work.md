...
learner and conversation ownership. Rust owns conversation difficulty and language
progress profiles. Remaining settings work includes conversation-scoped assistance
and goals, relationship defaults, durable storage design and the shared frontend store. Contacts, gardens and language-service work remain planned.
