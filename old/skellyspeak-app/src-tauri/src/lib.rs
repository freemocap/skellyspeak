...
pub fn run() {
    ...
    builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::conversations::get_conversation_practice,
            commands::conversations::save_conversation_practice,
            ...
            commands::skills::save_language_profile,
