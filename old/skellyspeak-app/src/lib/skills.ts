...
export function saveLanguageProfile(choices: LanguageProfile): Promise<SkillSnapshot> {
  return invoke('save_language_profile', { target: choices.target, expectedRevision: choices.revision, choices })
}
