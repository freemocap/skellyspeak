...
import type { LanguageProfile, SkillProgress, SkillSnapshot } from '../lib/skills'
...
export function SkillTreeView({ snapshot, demonstration, refresh, save, saving, onPractice }: { snapshot: SkillSnapshot; demonstration: boolean; refresh: () => void; save: (choices: LanguageProfile) => Promise<void>; saving: boolean; onPractice: () => void }) {
  ...
  const update = async (choices: LanguageProfile, practice: boolean) => {
