...
> Historical design snapshot, relocated on 2026-09-15. Retained for rationale;
> implementation-status and future-work claims below have not been re-audited
> against current code. This is not a current specification.
...
and application rejection tests verify this policy; see [fixture provenance](../../../../native/src/language/linguistics/fixtures/README.md).
...
[grapheme-recommendation.md](grapheme-recommendation.md) defines a finite format comparison; neither
