...
- The coaching plan, this work plan, contracts, `references.bib`, a static reading view (`docs/website/static/coaching-plan.html`), and pointers in `AGENTS.md`, `DESIGN.md` and `BUILD-PLAN.md`.
