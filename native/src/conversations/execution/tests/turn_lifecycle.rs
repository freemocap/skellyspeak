...
fn send_is_atomic_idempotent_and_only_one_pending_reply() {
    ...
    assert_eq!(snapshot.turns[0].operations.len(), 10); // Brief and feedback are automatic; grammar and suggestions are requested; read aloud is disabled in this fixture.
}
