...
INSERT INTO ai_config VALUES(1,1,NULL,'google/gemini-2.5-flash','google/gemini-2.5-flash-lite','{"transcription":{"model":"scribe_v2"},"speech":{"model":"eleven_v3"}}',0,'hosted',NULL,'',NULL,NULL,'{"baseUrl":"http://127.0.0.1:8765/v1","bearerAuth":true}','chat_model');
