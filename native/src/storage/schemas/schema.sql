...
INSERT INTO ai_config VALUES(1,1,'google/gemini-2.5-flash','google/gemini-2.5-flash-lite','{"transcription":{"model":"whisper-large-v3"},"speech":{"model":"eleven_v3"}}',0,'hosted',NULL,'',NULL,'{"baseUrl":"http://127.0.0.1:8765/v1","bearerAuth":true}','chat_model');
...
CREATE TABLE inference_holds(id TEXT PRIMARY KEY, generation TEXT NOT NULL, route TEXT NOT NULL CHECK(route IN ('hosted','custom')), error TEXT NOT NULL CHECK(json_valid(error)));
